...
<asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnFilter">
    <div class="form-horizontal form-filter">
        ...
        <div class="form-group">
            <div class="filter-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="LocalizedLabel1" runat="server" EnableViewState="false" Text="Topdog Number" />
            </div>
            <div class="filter-form-value-cell">
                <cms:CMSTextBox ID="txtTopDogNumber" runat="server" MaxLength="20" EnableViewState="false" />
            </div>
        </div>
