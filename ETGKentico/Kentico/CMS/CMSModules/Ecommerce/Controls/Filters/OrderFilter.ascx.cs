...
public partial class CMSModules_Ecommerce_Controls_Filters_OrderFilter : CMSAbstractDataFilterControl
{
    ...
    private WhereCondition GetFilterWhereCondition()
    {
        ...
        // Order identifier
        var filterTopdogNumber = txtTopDogNumber.Text.Trim().Truncate(txtTopDogNumber.MaxLength);
        if (filterTopdogNumber != String.Empty)
        {
            condition.Where(w => w.WhereEquals("OrderTopdogNumber", filterTopdogNumber));
        }
    ...
    public override void ResetFilter()
    {
        ...
        txtTopDogNumber.Text = string.Empty;
