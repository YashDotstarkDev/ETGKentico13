...
namespace ETG.Core.PageTypes.Providers
{
    ...
    {
        /// <summary>
        /// Returns a query that selects published pages of type Article.
        /// </summary>
        public static DocumentQuery<Article> GetArticles()
        {
            return DocumentHelper.GetDocuments<Article>().PublishedVersion().Published();
        }


        /// <summary>
        /// Returns a published page of type Article that matches the specified criteria.
        /// </summary>
