...
import 'kleur/colors';
import 'html-escaper';
import { $ as $$PackageTile } from './CustomerReviews-CnogRZ0s.js';
import 'clsx';
...
/////
-->`;
}, "D:/Projects/Devotion/ETG/etg-astro/src/components/TourTilesCollection.astro", void 0);
...
}, "D:/Projects/Devotion/ETG/etg-astro/src/components/ArticleTile.astro", void 0);
...
blog-carousel Start
/////
-->${maybeRenderHead()}<div class="blog-carousel"> <div class="wrapper"> <h2 class="text-black text-center uppercase">Travel blogs &amp; guides</h2> <div class="prose text-body text-lg md:text-xl text-center mt-6 mx-auto max-w-5xl text-balance"> <p>Looking for more travel inspiration... We've got you covered.</p> <p>Explore our extensive range of travel blogs including the Canadian Rockies, Tropical Island escapes, immersive experiences across Europe and so much more.</p> </div> <div class="-mx-4 mt-6 2xl:-mx-16"> ${renderComponent($$result, "TilesCarousel", null, { "client:only": "vue", "client:component-hydration": "only", "client:component-path": "D:/Projects/Devotion/ETG/etg-astro/src/components/TilesCarousel.vue", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <div class="relative px-6 lg:px-16"> <div class="swiper isolate text-left text-sm font-semibold relative z-10"> <div class="swiper-wrapper"> <div class="swiper-slide"> ${renderComponent($$result2, "ArticleTile", $$ArticleTile, {})} </div> <div class="swiper-slide"> ${renderComponent($$result2, "ArticleTile", $$ArticleTile, {})} </div> <div class="swiper-slide"> ${renderComponent($$result2, "ArticleTile", $$ArticleTile, {})} </div> <div class="swiper-slide"> ${renderComponent($$result2, "ArticleTile", $$ArticleTile, {})} </div> <div class="swiper-slide"> ${renderComponent($$result2, "ArticleTile", $$ArticleTile, {})} </div> <div class="swiper-slide"> ${renderComponent($$result2, "ArticleTile", $$ArticleTile, {})} </div> </div> </div> <div class="button-prev cursor-pointer rounded-full w-[50px] h-[50px] bg-primary text-white hover:bg-body flex items-center justify-center text-lg transition-colors duration-300 absolute left-0 top-[65px] z-20"> <i class="fas fa-chevron-left"></i> </div> <div class="button-next cursor-pointer rounded-full w-[50px] h-[50px] bg-primary text-white hover:bg-body flex items-center justify-center text-lg transition-colors duration-300 absolute right-0 top-[65px] z-20"> <i class="fas fa-chevron-right"></i> </div> </div> ` })} </div> </div> </div> <!--
/////
blog-carousel End
/////
-->`;
}, "D:/Projects/Devotion/ETG/etg-astro/src/components/BlogCarousel.astro", void 0);
