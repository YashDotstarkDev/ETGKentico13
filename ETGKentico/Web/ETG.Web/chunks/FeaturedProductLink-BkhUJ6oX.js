...
import 'kleur/colors';
import 'html-escaper';
import { b as $$PackageTile } from './CustomerReviews-DhTMQL5p.js';
import 'clsx';
...
/////
-->`;
}, "D:/Source Code/_cut-etgp0001-entire-travel-group/src/components/TourTilesCollection.astro", void 0);
...
}, "D:/Source Code/_cut-etgp0001-entire-travel-group/src/components/ArticleTile.astro", void 0);
...
blog-carousel Start
/////
-->${maybeRenderHead()}<div class="blog-carousel"> <div class="wrapper"> <h2 class="text-black text-center uppercase">Travel blogs &amp; guides</h2> <div class="prose text-body text-lg md:text-xl text-center mt-6 mx-auto max-w-5xl text-balance"> <p>Looking for more travel inspiration... We've got you covered.</p> <p>Explore our extensive range of travel blogs including the Canadian Rockies, Tropical Island escapes, immersive experiences across Europe and so much more.</p> </div> <div class="flex flex-wrap -mx-4 justify-center mt-8"> <div class="tile p-4 w-full md:w-1/2 xl:w-1/4"> ${renderComponent($$result, "ArticleTile", $$ArticleTile, {})} </div> <div class="tile p-4 w-full md:w-1/2 xl:w-1/4"> ${renderComponent($$result, "ArticleTile", $$ArticleTile, {})} </div> <div class="tile p-4 w-full md:w-1/2 xl:w-1/4"> ${renderComponent($$result, "ArticleTile", $$ArticleTile, {})} </div> <div class="tile p-4 w-full md:w-1/2 xl:w-1/4"> ${renderComponent($$result, "ArticleTile", $$ArticleTile, {})} </div> <div class="tile p-4 w-full md:w-1/2 xl:w-1/4"> ${renderComponent($$result, "ArticleTile", $$ArticleTile, {})} </div> <div class="tile p-4 w-full md:w-1/2 xl:w-1/4"> ${renderComponent($$result, "ArticleTile", $$ArticleTile, {})} </div> </div> <div class="cta mt-8 flex justify-center"> <a href="#" class="btn btn-primary-outline">View all</a> </div> <!--<div class="-mx-4 mt-6 2xl:-mx-16">--> <!--    <TilesCarousel client:only="vue">--> <!--        <div class="relative px-6 lg:px-16">--> <!--            <div class="swiper isolate text-left text-sm font-semibold relative z-10">--> <!--                <div class="swiper-wrapper">--> <!--                    <div class="swiper-slide">--> <!--                        <ArticleTile />--> <!--                    </div>--> <!--                    <div class="swiper-slide">--> <!--                        <ArticleTile />--> <!--                    </div>--> <!--                    <div class="swiper-slide">--> <!--                        <ArticleTile />--> <!--                    </div>--> <!--                    <div class="swiper-slide">--> <!--                        <ArticleTile />--> <!--                    </div>--> <!--                    <div class="swiper-slide">--> <!--                        <ArticleTile />--> <!--                    </div>--> <!--                    <div class="swiper-slide">--> <!--                        <ArticleTile />--> <!--                    </div>--> <!--                </div>--> <!--            </div>--> <!--            <div class="button-prev cursor-pointer rounded-full w-[50px] h-[50px] bg-primary text-white hover:bg-body flex items-center justify-center text-lg transition-colors duration-300 absolute left-0 top-[65px] z-20">--> <!--                <i class="fas fa-chevron-left"></i>--> <!--            </div>--> <!--            <div class="button-next cursor-pointer rounded-full w-[50px] h-[50px] bg-primary text-white hover:bg-body flex items-center justify-center text-lg transition-colors duration-300 absolute right-0 top-[65px] z-20">--> <!--                <i class="fas fa-chevron-right"></i>--> <!--            </div>--> <!--        </div>--> <!--    </TilesCarousel>--> <!--</div>--> </div> </div> <!--
/////
blog-carousel End
/////
-->`;
}, "D:/Source Code/_cut-etgp0001-entire-travel-group/src/components/BlogCarousel.astro", void 0);

const $$FeaturedProductLink = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<a href="#" class="group block hover:no-underline relative rounded-md overflow-hidden isolate text-white bg-black"> <span class="background-image image-container absolute inset-0 z-0 opacity-60"> <img data-lowsrc="https://entiretravel.imgix.net/getmedia/bcc3edea-2369-4774-b62a-a6669554644a/Group-Journeys-275x400.jpg?auto=format&w=3" data-src="https://entiretravel.imgix.net/getmedia/bcc3edea-2369-4774-b62a-a6669554644a/Group-Journeys-275x400.jpg?auto=format&w={width}&h=420&fit=crop" data-sizes="auto" class="lazyload absolute z-0 inset-0 w-full h-full object-cover group-hover:scale-105 transition-all duration-300" alt="Hilton Moorea Lagoon Resort & Spa"> </span> <span class="foreground flex flex-col justify-end gap-4 p-10 relative z-20 h-[400px]"> <span class="uppercase text-2xl font-bold">Entire group journeys</span> <span>Explore our signature range of group travel experiences.</span> <span class="cta btn mt-4 bg-primary group-hover:bg-black">Explore</span> </span> </a>`;
}, "D:/Source Code/_cut-etgp0001-entire-travel-group/src/components/FeaturedProductLink.astro", void 0);

export { $$TourTilesCollection as $, $$BlogCarousel as a, $$FeaturedProductLink as b };
