...
const $$NewHero = createComponent(($$result, $$props, $$slots) => {
...
</div> </div> </div> <div class="share-container absolute right-8 bottom-0 translate-y-1/2 z-20"> ${renderComponent($$result, "ShareButton", null, { "client:only": "vue", "url": "https://url.to.share", "title": "Title to share", "text": "Text to share", "client:component-hydration": "only", "client:component-path": "C:/Projects/ETG/Source/_cut-etgp0001-entire-travel-group/src/components/ShareButton.vue", "client:component-export": "default" })} </div> </div> <div class="w-full max-w-4xl mx-auto mt-12 md:mt-20"> <div class="mt-12 uppercase text-primary"> <h1>Use a h1 here if there's none in the hero</h1> <h2 class="h1">Otherwise use a h2 - both are styled the same</h2> </div> <div class="mt-8 text-intro">
...
/////
-->`;
}, "C:/Projects/ETG/Source/_cut-etgp0001-entire-travel-group/src/components/NewHero.astro", void 0);
